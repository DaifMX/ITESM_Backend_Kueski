...
export default class OrderService {
    ...
    private parseKueskiOrder = async (order: OrderModel) => {
        ...
        const kueskiOrderBody = {
            ...
            callbacks: {
                on_success: `https://daif-201.ddns.me/success/${order.uuid}`,
                on_reject: `https://daif-201.ddns.me/reject/${order.uuid}`,
                on_canceled: `https://daif-201.ddns.me/canceled/${order.uuid}`,
                on_failed: `https://daif-201.ddns.me/failed/${order.uuid}`
            }
        };
